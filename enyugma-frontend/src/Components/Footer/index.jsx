...
import IIItbLogo from "../../assets/iiitbh.webp";
import "./footer.scss";
        ...
        <footer className="footer">
            <div className="footer-content">
                ...
                <div className="footer-section ">
                    ...
                    <Link to="/our-team" className="OurTeamBtn">
                        Our Team
                    </Link>
                </div>
            </div>
            ...
            <div className="footer-bottom">
                <p>
                    &copy; {new Date().getFullYear()} Indian Institute of
                    Information Technology Bhagalpur. All right reserved.
                </p>
            </div>
        </footer>
    );
