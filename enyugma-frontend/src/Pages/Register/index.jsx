...
export default function Register() {
  ...
  const [isTransactionIdRequired, setIsTransactionIdRequired] = useState(false);
  ...
  const handleSubmit = async () => {
    ...
    await fetch("http://localhost:3010/api/user/register", {
      method: "POST",
      body: formData,
    })
      .then((res) => res.json())
      .then((res) => {
        ...
        if (
          ...
          window.location.href =
            "https://www.kaggle.com/competitions/grid-optimization-challenge-iiit-bhagalpur-enyugma";
        } else {
          window.location.href = "/";
        }
      })
          ...
          <ThemeProvider theme={darkTheme}>
            ...
            >
              <Paper className="qrcode" elevation={8}>
                <img className="code" src={qrcode} alt="qr code" />
                ...
                <img className="preview" src="" alt="preview" id="preview" />
              </Paper>
              <Paper className="form" elevation={2} component="form">
                ...
                <FormControl fullWidth className="row">
                  ...
                  />
                  {mobileError && (
                    <FormHelperText error>{mobileError}</FormHelperText>
                  )}
                </FormControl>
                <FormControl fullWidth>
                  ...
                  />
                  {collegeError && (
                    <FormHelperText error>{collegeError}</FormHelperText>
                  )}
                </FormControl>
                <FormControl fullWidth className="row">
                  <TextField
                ...
                <FormControl fullWidth className="row">
                  ...
                  >
                    ...
                    <MenuItem value="congingent">Congingent</MenuItem>
                  </Select>
                  {typeError && (
                  ...
                  {sizeError && (
                    <FormHelperText error>{sizeError}</FormHelperText>
                  )}
                </FormControl>
                <FormControl fullWidth className="row">
                  <MultipleSelectEvent
                    isTransactionIdRequired={isTransactionIdRequired}
                    setIsTransactionIdRequired={setIsTransactionIdRequired}
                    setEvents={setEvents}
                  />
                  {eventsError && (
                    <FormHelperText error>{eventsError}</FormHelperText>
                  )}
                </FormControl>
                <FormControl fullWidth className="row">
                  <TextField
                  ...
                  />
                  {transactionIdError && (
                    <FormHelperText error>{transactionIdError}</FormHelperText>
                  )}
                  <TextField
